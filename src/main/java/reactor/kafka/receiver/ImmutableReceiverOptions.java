...
import reactor.kafka.receiver.errors.LogAndFailReceiverExceptionHandle;
...
class ImmutableReceiverOptions<K, V> implements ReceiverOptions<K, V> {
    ...
    ImmutableReceiverOptions(
        ...
        this.receiverExceptionHandler = receiverExceptionHandler == null ? new LogAndFailReceiverExceptionHandle() : receiverExceptionHandler;
    }
